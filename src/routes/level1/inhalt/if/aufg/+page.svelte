...
>
  <CodeBlock>
    ...
    <CodeInput bind:value={firstInput} state={firstInputState} placeholder="Name Var + Input" />

    <CodeInput bind:value={secondInput} state={secondInputState} placeholder="Alter Var + Input" />

    <code class="comment"># Überprüfe, ob der Benutzer volljährig ist (18 Jahre oder älter)</code>
    if <CodeInput bind:value={firstIf} state={firstIfState} placeholder="Var + Vergleich" width="15vw" /> 18:
    ...
    if <CodeInput bind:value={secondIf} state={secondIfState} placeholder="Var + Vergleich" width="15vw" /> 18:
    print("Du bist nicht volljährig")
    else:
    print("Du bist volljährig")

    <code class="comment"># Überprüfe, ob der Name richtig ist (Ob die Namen identisch sind).</code>
    if <CodeInput bind:value={thirdIf} state={thirdIfState} placeholder="Var + Vergleich" width="15vw" /> "{$nameStore}":
    ...
    if 6 <CodeInput bind:value={fourthIf} state={fourthIfState} placeholder="Vergleich + Var" width="10vw" />.len():
  ...
  <div class="interactive-console">
    <pre class="cmd {outputColorClass}">
      ...
      <code style="color: var(--mauve); font-weight:600; font-size: 2vh">> Wenn du beides falsch gemacht hast,<br>> wird dir das Eingabefeld in lila angezeigt.</code></code><code class="{success}"><code class="{outputState1}">> <code style="color: var(--peach);">{firstInputQuestion}</code> <input
        ...
        /></code><code class="{output1ValState}">> <code style="color: var(--peach);">{firstInputQuestion}</code> <code style="color: var(--teal);">{outputVal1}</code></code>
      <code class="{outputState2}">> <code style="color: var(--peach);">{secondInputQuestion}</code> <input
        ...
        /></code><code class="{output2ValState}">> <code style="color: var(--peach);">{secondInputQuestion}</code> <code style="color: var(--teal);">{outputVal2}</code></code>
      ...
      <code class="{outputState3}">> <code style="color: var(--peach);">{secondInputReaNewQuestion}</code> <input
        ...
        /></code><code class="{output3ValState}">> <code style="color: var(--peach);">{secondInputReaNewQuestion}</code> <code style="color: var(--teal);">{outputVal3}</code></code>
